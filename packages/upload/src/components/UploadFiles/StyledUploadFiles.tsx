  ...
  .filepond {
    ...
    &--file {
      ...
      .filepond--progress-indicator {
        ...
        right: 0.7em;
        font-size: 0.9em;
        color: ${theme.alias.color.text.feedback.secondary.base};
        transform: scale(1.5);
      }
    ...
    &--progress-indicator {
      ...
      width: 1.625em;
      height: 1.625em;
      color: ${theme.alias.color.text.body.inverse};
      margin: 0;
      pointer-events: none;
      will-change: transform, opacity;
    ...
    &-idle {
      ...
      color: ${
        theme.meta.scheme === 'dark'
          ? theme.alias.color.background.surface.blend.dark.stronger
          : theme.alias.color.background.surface.blend.light.strongest
      };
    }

    &-success {
      mix-blend-mode: normal;
      color: ${theme.alias.color.background.feedback.error.stronger};
    }

    &-failure {
      mix-blend-mode: normal;
      color: ${theme.alias.color.background.feedback.error.weak};
    }
  }
