...
export interface makeStyledSelectProps {
  ...
  status?: FieldStatus;
  theme: DefaultTheme;
  value: any; // TODO: check type
  options: any; // TODO: check type
  size: any; // TODO: check type
}

export const makeStyledSelect = (component) => {
  return styled(component).attrs(({ className, classNamePrefix }) => ({
      ...
      return css`
        .${classNamePrefix} {
          ...
          &__control {
            ...
            background-color: ${fieldTokens.color.background[statusEval][
              state
            ]};
          ...
          &__value-wrapper {
            ...
            .${classNamePrefix}__value-container.${classNamePrefix}__value-container--is-multi {
              ...
              &.${classNamePrefix}__value-container--has-value {
                padding-right: calc(
                  ${indicatorWidth} * ${hasDropdownIndicator} +
                    ${sortableSpacing} + ${indicatorWidth} *
                    ${hasClearIndicator} + ${defaultHorPadding}
                );
              }
            }
                ...
                &.${classNamePrefix}__value-container--has-value {
                  padding-right: calc(
                    ${indicatorWidth} * ${hasDropdownIndicator} +
                      ...
                      ${scrollSpacing} + ${sortableSpacing} +
                      ${defaultHorPadding} + ${scrollOffset}
                  );
                }
              }
          ...
          &__value-container {
            ...
            .${classNamePrefix} {
              ...
              &__single-value {
                ...
                i {
                  margin-right: ${selectTokens.valueIcon.space.marginRight[
                    size
                  ]};
