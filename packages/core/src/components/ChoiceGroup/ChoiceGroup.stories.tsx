...
export const SizeAndColors: Story = {
  render: () =>
    (() => (
      <>
        <HFlex spacing="0">
          ...
          <Divider vertical />
          <ChoiceGroup>
            <IconButton icon="chart" name="uncontrolled" size="sm" />
            <IconButton icon="chart_agg" name="uncontrolled" size="sm" />
            <IconButton icon="chart_donut" name="uncontrolled" size="sm" />
            <IconButton
              icon="chart_sankey"
              name="uncontrolled"
              size="sm"
        ...
        <Divider />
        <ChoiceGroup>
          <IconButton icon="chart" name="uncontrolled" />
          <IconButton icon="chart_agg" name="uncontrolled" />
          <IconButton icon="chart_donut" name="uncontrolled" />
          <IconButton icon="chart_sankey" name="uncontrolled" />
        </ChoiceGroup>
        <Divider />
        <ChoiceGroup>
          <IconButton
