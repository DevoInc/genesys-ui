...
import * as CasesStories from './ChoiceGroup.stories';
...
<Canvas of={CasesStories.MultipleSelectionControlled} />
...
<Canvas of={CasesStories.MultipleSelectionUncontrolled} />
...
<Canvas of={CasesStories.SingleSelectionControlled} />
...
<Canvas of={CasesStories.SingleSelectionUncontrolled} />
