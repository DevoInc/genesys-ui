...
A Dropdown component is an element that allows users to select an option
from a drop-down list.
This component is valuable in web applications to enhance usability by
reducing the amount of
screen space used to display options, especially when there are multiple
choices available.

This compoennt is based on `popper.js` library.
...
- `ref`: used to retrieve the React refd of the _popper_ element.
- `toggle`: funtion to toggle the content of the component.
