...
- `selectedDates`: Array of dates (Date | number), that create the both versions
...
<Canvas of={Stories.HookSingleDay} />
...
<Source
code={`
import { useCalendarSingleDay } from '@devoinc/genesys-ui-datetime';
...
<Source
code={`import { useCalendarForward } from '@devoinc/genesys-ui-datetime';
...
<Source
code={`import { forwardBehavior } from '@devoinc/genesys-ui-datetime';

const newRange = forwardBehavior([from, to], newDate: number | Date);
`}
/>
...
<Canvas of={Stories.HookForwardBackward} />
...
<Source
code={`
import { useCalendarForwardBackward } from '@devoinc/genesys-ui-datetime';
...
<Source
code={`import { forwardBackwardBehavior } from '@devoinc/genesys-ui-datetime';
