...
import * as Stories from './DateTimeRangeInput.stories';
...
<Source
  code={`import { DateTimeRangeInput } from '@devoinc/genesys-ui-datetime';`}
/>
...
<ArgTypes of={Stories} />
UsingExpressions ./DateTimeRangeInput.stories
