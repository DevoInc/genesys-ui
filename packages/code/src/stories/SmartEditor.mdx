...
import { SmartEditor, getTheme } from '@devoinc/genesys-ui-code';
...
import { SmartEditor, getTheme, useEditor } from '@devoinc/genesys-ui-code';
...
<SmartEditor.Container>
  ...
  />
  <SmartEditor.ActionsContainer>{actions}</SmartEditor.ActionsContainer>
</SmartEditor.Container>
); }; `} />
