...
Visit [stories/cases/CustomTheme.tsx](https://github.com/DevoInc/genesys-ui/blob/master/packages/code/src/components/DiffEditor/stories/cases/CustomTheme.tsx) for a code example.
