...
<Heading.H2>Installing Genesys-ui into your application</Heading.H2>
...
<Heading.H2>Adding a theme</Heading.H2>
...
<Heading.H2>Making styled-components aware of the theme's schema</Heading.H2>
