...
<H1>Integrating genesys-ui into a React project with styled-components</H1>
...
<H2>Adding Genesys-ui to your project</H2>
...
<H2>Adding required base styles</H2>
...
<H2>Adding support for icons</H2>
