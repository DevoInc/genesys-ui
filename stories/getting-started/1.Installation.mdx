...
<Heading.H1>Integrating genesys-ui into a React project</Heading.H1>
...
<Heading.H2>Adding Genesys-ui to your project</Heading.H2>
...
<Heading.H2>Adding required base styles</Heading.H2>
...
<Heading.H2>Adding support for icons</Heading.H2>
...
<Heading.H2>Adding a custom brand</Heading.H2>
